...
TRUNCATE TABLE Body;
INSERT INTO Body VALUES ('1','1','le corps d''Arsenic','498546','{}','1');
INSERT INTO Body VALUES ('2','1','le corps d''Arsenic','498327','{}','1');
INSERT INTO Body VALUES ('3','1000000','un écureuil roux mort','498533','{}','1');
INSERT INTO Body VALUES ('4','1000000','un écureuil roux mort','498859','{}','1');
INSERT INTO Body VALUES ('5','1000000','un écureuil roux mort','498924','{}','2');
...
INSERT INTO Command VALUES ('20','olc','a_olc','0','1','1','1','0','olc [class]','Affiche la liste des classes ainsi que la liste des objets de la classe précisée.');
INSERT INTO Command VALUES ('21','olcShow','a_olc','0','1','1','1','0','olc_show class id','Affiche les données de l''objet de classe <b>class</b> et d''identifiant <b>id</b>');
...
INSERT INTO Command VALUES ('27','ruby','a_divers','0','1','1','1','0','ruby <code>','Exécute le <b>code</b>.<br><u>Exemple :</u> ruby Save.world');
...
INSERT INTO Command VALUES ('31','set','a_olc','0','1','1','1','0','set class id variable value','Donne la valeur <b>value</b> à la <b>variable</b> pour l''objet de classe <b>class</b> identifié par <b>id</b>');
...
INSERT INTO Command VALUES ('38','redit','a_olc','0','1','1','1','0','redit','Affiche l''éditeur des salles');
INSERT INTO Command VALUES ('39','rcreate','a_olc','0','1','1','1','0','rcreate [nseobh]','Exemple : rcreate n pour créer une nouvelle salle au nord.
...
INSERT INTO Command VALUES ('41','include','a_divers','0','1','1','1','0','include path','Tente de charger le fichier indiqué par <b>path</b>. Utiliser avec précaution...');
...
INSERT INTO Command VALUES ('','reply','communication','0','0','0','1','0','reply nom','Permet de répondre à quelqu''un après qu''il vous ai envoyé un message via la commande tell.');
INSERT INTO Command VALUES ('score','score','gestion','0','1','0','1','0','score','Affiche diverses informations sur votre personnage.');
INSERT INTO Command VALUES ('spells','spells','gestion','0','1','0','1','0','spells','Affiche une liste des sortilèges que vous connaissez et votre niveau de maîtrise pour ces sorts.');
TRUNCATE TABLE Heroe;
INSERT INTO Heroe VALUES ('1','Arsenic','37eff4bfa7d88a6e75c8804ecff8659b','1','{:taille=>1, :haircolor=>1, :hairlength=>1, :eyecolor=>1}','1','13','2','28','28','15','15','5','8','5','5','default','default','0','{}','{5=>3, 2=>24, 6=>6}','{}','[["Weapon 8", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["test", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]','1140');
INSERT INTO Heroe VALUES ('2','Dominic','37eff4bfa7d88a6e75c8804ecff8659b','1','{:taille=>1, :haircolor=>1, :hairlength=>1, :eyecolor=>1}','1','0','1','20','20','10','10','5','5','5','5','default','default','0','{}','{}','{}','[["Lettre 2", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]','-2580');
INSERT INTO Heroe VALUES ('3','Maxime','b238c13e822536cad3ac57a2280fbf45','1','{:taille=>4, :haircolor=>5, :hairlength=>2, :eyecolor=>3}','1','0','1','20','20','10','10','5','5','5','5','default','default','0','{}','{}','{}','[["Lettre 2", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]','0');
TRUNCATE TABLE Item;
...
INSERT INTO System VALUES ('1','world_time','498288');
INSERT INTO System VALUES ('2','time_difference','1274052912');
