...
TRUNCATE TABLE Body;
INSERT INTO Body VALUES ('1','1000000','un écureuil roux mort','503187','{}','2');
...
INSERT INTO Command VALUES ('4','clone','a_olc','0','1','1','1','0','clone class id','Clone l''objet de classe <b>class</b> identifié par <b>id</b> et lui attribue un nouvel identifiant');
...
INSERT INTO Command VALUES ('6','dump','a_divers','0','1','1','1','0','dump (variable)','Affiche la structure d''une <b>variable</b>.<br><u>Exemple :</u> dump $h
...
INSERT INTO Command VALUES ('7','edit','a_olc','0','1','1','1','0','edit class id','Affiche une page de modification pour l''objet de classe <b>class</b> identifié par <b>id</b>');
...
INSERT INTO Command VALUES ('12','giveXp','a_gestion','0','1','1','1','0','giveXp player xp','Confère <b>xp</b> points d''expériences à <b>player</b>');
INSERT INTO Command VALUES ('13','goto','a_divers','0','1','1','1','0','goto [zone]','Affiche la liste des zones où déplace vers la zone indiquée');
INSERT INTO Command VALUES ('14','help','a_divers','0','1','1','1','0','help [command]','Affiche de l''aide sur <b>command</b> ou affiche une liste des commandes');
...
INSERT INTO Command VALUES ('18','lvUp','a_gestion','0','1','1','1','0','lvUp player','Incrémente le niveau de <b>player</b> sans laisser d''xp au delà');
INSERT INTO Command VALUES ('19','olc','a_olc','0','1','1','1','0','olc [class]','Affiche la liste des classes ainsi que la liste des objets de la classe précisée.');
INSERT INTO Command VALUES ('20','olcShow','a_olc','0','1','1','1','0','olc_show class id','Affiche les données de l''objet de classe <b>class</b> et d''identifiant <b>id</b>');
INSERT INTO Command VALUES ('21','option','divers','0','1','0','1','0','option','Accède à un panneau permettant de régler différentes options.');
INSERT INTO Command VALUES ('22','shortcut','gestion','0','1','0','0','1','shortcut action id','Permet de modifier les raccourcis');
INSERT INTO Command VALUES ('23','pray','communication','0','0','0','1','0','pray message','Permet de contacter un admin afin de faire une demande ou signaler un problème quelconque.');
INSERT INTO Command VALUES ('24','remove','gestion','1','0','0','1','0','remove objet','Remet un objet équipé dans votre sac.');
INSERT INTO Command VALUES ('25','ruby','a_divers','0','1','1','1','0','ruby <code>','Exécute le <b>code</b>.<br><u>Exemple :</u> ruby Save.world');
INSERT INTO Command VALUES ('26','say','communication','1','0','0','1','0','say message','Vous dites quelque chose à voix normale et  ne serez entendu que par des personnes à proximité.');
INSERT INTO Command VALUES ('27','selectAvatar','gestion','0','0','0','0','1','selectAvatar','Il n''y a pas d''aide là-dessus.');
INSERT INTO Command VALUES ('28','selectSkin','gestion','0','0','0','0','1','selectSkin','Il n''y a pas d''aide là-dessus.');
INSERT INTO Command VALUES ('29','set','a_olc','0','1','1','1','0','set class id variable value','Donne la valeur <b>value</b> à la <b>variable</b> pour l''objet de classe <b>class</b> identifié par <b>id</b>');
INSERT INTO Command VALUES ('30','shout','communication','1','0','0','1','0','shout message','Envoie un message aux personnages se trouvant dans la zone.');
INSERT INTO Command VALUES ('31','summonItem','a_olc','0','1','1','1','0','summonItem &lt;nombre&gt; &lt;objet&gt;','Invoquer un objet dans votre inventaire.');
INSERT INTO Command VALUES ('32','tell','communication','0','0','0','1','0','tell nom message','Dit à <b>nom</b>, le <b>message</b>. Sensible à la casse et à l''état du joueur visé.');
INSERT INTO Command VALUES ('33','time','divers','0','0','0','1','0','time','Affiche la date et l''heure actuelle.');
INSERT INTO Command VALUES ('34','wear','gestion','1','0','0','1','0','wear objet','Équipe un objet de votre inventaire.');
INSERT INTO Command VALUES ('35','who','divers','0','0','0','1','0','who','Affiche la liste des joueurs connectés.');
INSERT INTO Command VALUES ('36','redit','a_olc','0','1','1','1','0','redit','Affiche l''éditeur des salles');
INSERT INTO Command VALUES ('37','rcreate','a_olc','0','1','1','1','0','rcreate [nseobh]','Exemple : rcreate n pour créer une nouvelle salle au nord.
...
INSERT INTO Command VALUES ('38','eat','gestion','1','0','0','1','0','eat nourriture','exemple : eat cèpe pour manger un cèpe');
INSERT INTO Command VALUES ('39','include','a_divers','0','1','1','1','0','include path','Tente de charger le fichier indiqué par <b>path</b>. Utiliser avec précaution...');
INSERT INTO Command VALUES ('40','special','divers','1','1','0','0','1','non déclarée','Il n''y a pas d''aide à propos de cette commande.');
INSERT INTO Command VALUES ('41','equipement','gestion','0','0','0','1','0','equipement','Liste les objets que vous portez sur le corps.');
INSERT INTO Command VALUES ('42','drag','action','1','0','0','1','0','drag &lt;corps&gt; to &lt;direction&gt;','Permet de déplacer un corps avec soi vers une sortie.');
INSERT INTO Command VALUES ('43','reply','communication','0','0','0','1','0','reply nom','Permet de répondre à quelqu''un après qu''il vous ai envoyé un message via la commande tell.');
INSERT INTO Command VALUES ('44','score','gestion','0','1','0','1','0','score','Affiche diverses informations sur votre personnage.');
INSERT INTO Command VALUES ('45','spells','gestion','0','1','0','1','0','spells','Affiche une liste des sortilèges que vous connaissez et votre niveau de maîtrise pour ces sorts.');
INSERT INTO Command VALUES ('46','affections','gestion','0','1','0','1','0','affections','Affiche une liste des enchantements et maléfices qui vous affectent.');
INSERT INTO Command VALUES ('47','spell','divers','0','1','0','1','0','spell &lt;sortilège&gt;','Affiche des informations sur un sort.');
TRUNCATE TABLE Heroe;
INSERT INTO Heroe VALUES ('1','Arsenic','37eff4bfa7d88a6e75c8804ecff8659b','1','{:taille=>1, :haircolor=>1, :hairlength=>1, :eyecolor=>1}','2','26','2','19','28','1000','1000','5','8','5','5','default','default','{$spell[1]=>72, $spell[2]=>100}','{5=>3, 2=>24, 6=>6}','{}','[["Weapon 8", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["test", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]','900');
...
INSERT INTO System VALUES ('1','world_time','502516');
INSERT INTO System VALUES ('2','time_difference','1274105811');
