...
INSERT INTO Heroe VALUES ('1','Arsenic','37eff4bfa7d88a6e75c8804ecff8659b','1','{:taille=>1, :haircolor=>1, :hairlength=>1, :eyecolor=>1}','1','26','2','28','28','1000','1000','5','8','5','5','default','default','{1=>72, 2=>100}','{5=>5, 4=>5, 2=>36, 6=>6}','{}','[["Weapon 8", "Joyaux 6", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["test", "o", "inventory", "who", "get *", "option", "n", "s", "e", "aide"]]','120');
...
TRUNCATE TABLE Mob;
TRUNCATE TABLE Room;
INSERT INTO Room VALUES ('1','Cour de l''académie','Vous vous trouvez dans une grande cour adjacente à l''entrée de l''Académie de Mira, le lieu de formation des mages et guerriers de votre ville natale. L''entraînement au combat se fait dans les jardins à l''ouest. Tapez o, ouest ou cliquez sur le lien ouest pour vous y aventurer. Vous pouvez aussi choisir d''entrer dans l''académie et voir ce qui vous y attends.','2','1','0','{4=>5, 5=>2, 2=>11}','{4=>5, 5=>2, 2=>11}','{}');
TRUNCATE TABLE Shop;
TRUNCATE TABLE Skin;
...
INSERT INTO System VALUES ('1','world_time','687352');
INSERT INTO System VALUES ('2','time_difference','1274395241');
