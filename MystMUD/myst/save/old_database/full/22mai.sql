...
--
-- Serveur: localhost
-- Généré le : Sam 22 Mai 2010 à 19:29
...
INSERT INTO `body` (`id`, `aid`, `name`, `expire`, `inv`, `room`) VALUES
(1, 1, 'le corps d''Arsenic', 498546, '{}', 1),
(2, 1, 'le corps d''Arsenic', 498327, '{}', 1),
(3, 1000000, 'un écureuil roux mort', 498533, '{}', 1),
(4, 1000000, 'un écureuil roux mort', 498859, '{}', 1),
(5, 1000000, 'un écureuil roux mort', 498924, '{}', 2);
...
('33', 'summonItem', 'a_olc', 0, 1, 1, 1, 0, 'summonItem &lt;nombre&gt; &lt;objet&gt;', 'Invoquer un objet dans votre inventaire.'),
...
('44', 'drag', 'action', 1, 0, 0, 1, 0, 'drag &lt;corps&gt; to &lt;direction&gt;', 'Permet de déplacer un corps avec soi vers une sortie.'),
('', 'reply', 'communication', 0, 0, 0, 1, 0, 'reply nom', 'Permet de répondre à quelqu''un après qu''il vous ai envoyé un message via la commande tell.'),
('score', 'score', 'gestion', 0, 1, 0, 1, 0, 'score', 'Affiche diverses informations sur votre personnage.');
...
(1, 'Arsenic', '37eff4bfa7d88a6e75c8804ecff8659b', 1, '{:taille=>1, :haircolor=>1, :hairlength=>1, :eyecolor=>1}', 1, 13, 2, 28, 28, 15, 15, 5, 8, 5, 5, 'default', 'default', 0, '{}', '{5=>3, 2=>24, 6=>6}', '{}', '[["Weapon 8", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["test", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]', 1140),
...
(3, 'Maxime', 'b238c13e822536cad3ac57a2280fbf45', 1, '{:taille=>4, :haircolor=>5, :hairlength=>2, :eyecolor=>3}', 1, 0, 1, 20, 20, 10, 10, 5, 5, 5, 5, 'default', 'default', 0, '{}', '{}', '{}', '[["Lettre 2", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]', 0);
...
(3, 'Le bois d''Aulne', 'Vous traversez quelques branchages et continuez votre chemin. Vous sentez une odeur particulière à l''est.', 1, 1, 0, '{2=>1}', '{2=>1}', '{:ouest=>2, :est=>4}'),
(4, 'Le bois d''Aulne', 'Une fumée s''échappe de sous vos pieds. Vous venez de marcher sur une vesse-de-loup. Vous vous rendez alors compte de l''énorme amas de champignons présent ici, semés entre la mousse et les fougères.', 2, 1, 0, '{4=>5, 5=>2, 2=>11}', '{4=>5, 5=>2, 2=>11}', '{:ouest=>3}');
...
CREATE TABLE IF NOT EXISTS `spell` (
  ...
  `need_target` tinyint(1) NOT NULL default '0',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
INSERT INTO `spell` (`id`, `name`, `desc`, `min_cost`, `max_cost`, `school`, `func`, `need_target`) VALUES
