...
--
-- Serveur: localhost
-- Généré le : Sam 13 Février 2010 à 16:29
...
('zfill', 'a_olc', 0, 1, 1, 0, 'zfill', 'Remplie la zone actuelle par l''icône de la position actuelle.'),
...
('special', 'divers', 1, 1, 0, 0, 'non déclarée', 'Il n''y a pas d''aide à propos de cette commande.');
...
INSERT INTO `heroe` (`id`, `name`, `password`, `authlevel`, `room`, `xp`, `level`, `hp`, `maxhp`, `mp`, `maxmp`, `str`, `con`, `wis`, `dex`, `skin`, `avatar`, `status`, `target`, `spell`, `inv`, `equip`, `shortcut`) VALUES
(1, 'Arsenic', '37eff4bfa7d88a6e75c8804ecff8659b', 1, 1, 0, 1, 42, 120, 10, 10, 5, 5, 5, 5, 'Queen01', 'epeiste2', '', 0, '{}', '{1=>5, 2=>4}', '{}', '[["Item 9", "olc"], ["Sac 1", "inventory"], ["Masque 1", "who"], ["Skill 5", "get *"], ["Parchemin 1", "option"], ["Joyaux 6", "o"], ["Joyaux 6", "n"], ["Joyaux 6", "s"], ["Joyaux 6", "e"], ["Skill 6", "aide"]]'),
(6, 'Conap', 'b7a616d4e7c1c12289c6bf3885f62f1a', 1, 1, 1514, 1, 46, 70, 10, 10, 8, 5, 5, 5, 'default', 'default', '', 0, '{}', '{3=>1000}', '{}', '[["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"]]'),
(8, 'Maxime', 'b238c13e822536cad3ac57a2280fbf45', 0, 1, 0, 1, 60, 60, 10, 10, 5, 5, 5, 5, 'default', 'default', '', 0, '{}', '{}', '{}', '[["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"], ["Lettre 2", "option shortcut"]]');
...
(1, 'une épée en bois de cerisier', 'weapon', 1, '[:bras_gauche, :bras_droit]', 'Cette épée d''entraînement ne permet de tuer que des rats (et encore)...', '{}', '{}', '{}', 0),
(2, 'un bâton de shaman', 'weapon', 10, '[:bras_gauche, :bras_droit]', 'C''est un bâton robuste orné d''une mâchoire de gobelin.', '{}', '{}', '{}', 0),
...
INSERT INTO `mob` (`id`, `name`, `room`, `level`, `hp`, `maxhp`, `mp`, `maxmp`, `str`, `con`, `wis`, `dex`, `skin`, `avatar`, `status`, `target`, `spell`, `inv`, `equip`) VALUES
(1000000, 'une souris', 1, 1, 50, 50, 100, 100, 5, 5, 5, 5, 'mob/Small04', 'mob/souris', '', 0, '{}', '{}', '{}');
...
INSERT INTO `room` (`id`, `name`, `desc`, `x`, `y`, `z`, `inv`) VALUES
(1, 'Salle de départ', '', 0, 0, 0, '');
...
INSERT INTO `world` (`id`, `name`, `cols`, `rows`, `zones`) VALUES
(1, 'Myst', 1, 1, '[1]');
