...
--
-- Serveur: localhost
-- Généré le : Dim 02 Mai 2010 à 02:28
...
('4', 'clone', 'a_olc', 0, 1, 1, 0, 0, 'clone class id', 'Clone l''objet de classe <b>class</b> identifié par <b>id</b> et lui attribue un nouvel identifiant'),
('5', 'drop', 'action', 1, 0, 0, 1, 0, 'drop [nombre] objet', 'Pose un objet de votre inventaire à votre position. "drop *" pour tout poser.'),
('6', 'dump', 'a_divers', 0, 1, 1, 0, 0, 'dump (variable)', 'Affiche la structure d''une <b>variable</b>.<br><u>Exemple :</u> dump $h\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\ndump tout court permet d''activer/désactiver l''affichage sur le terminal des réponses aux commandes (en html).'),
('7', 'edit', 'a_olc', 0, 1, 1, 0, 0, 'edit class id', 'Affiche une page de modification pour l''objet de classe <b>class</b> identifié par <b>id</b>'),
('8', 'examine', 'divers', 0, 0, 0, 1, 0, 'examine quelque-chose', 'Permet de scruter un corps ou examiner un objet de votre inventaire.'),
('9', 'force', 'a_gestion', 0, 1, 1, 0, 0, 'force someone to action', 'Permet de forcer un personnage à faire quelque chose.'),
...
('12', 'giveXp', 'a_gestion', 0, 1, 1, 0, 0, 'giveXp player xp', 'Confère <b>xp</b> points d''expériences à <b>player</b>'),
('13', 'goto', 'a_divers', 0, 1, 1, 0, 0, 'goto [zone]', 'Affiche la liste des zones où déplace vers la zone indiquée'),
('14', 'help', 'a_divers', 0, 1, 1, 0, 0, 'help [command]', 'Affiche de l''aide sur <b>command</b> ou affiche une liste des commandes'),
...
('18', 'lvUp', 'a_gestion', 0, 1, 1, 0, 0, 'lvUp player', 'Incrémente le niveau de <b>player</b> sans laisser d''xp au delà'),
('20', 'olc', 'a_olc', 0, 1, 1, 0, 0, 'olc [class]', 'Affiche la liste des classes ainsi que la liste des objets de la classe précisée.'),
('21', 'olcShow', 'a_olc', 0, 1, 1, 0, 0, 'olc_show class id', 'Affiche les données de l''objet de classe <b>class</b> et d''identifiant <b>id</b>'),
...
('27', 'ruby', 'a_divers', 0, 1, 1, 0, 0, 'php script_php', 'Exécute <b>script_php</b>.<br><u>Exemple :</u> php save::world();'),
...
('31', 'set', 'a_olc', 0, 1, 1, 0, 0, 'set class id variable value', 'Donne la valeur <b>value</b> à la <b>variable</b> pour l''objet de classe <b>class</b> identifié par <b>id</b>'),
('32', 'shout', 'communication', 1, 0, 0, 1, 0, 'shout message', 'Envoie un message aux personnages se trouvant dans la zone.'),
('33', 'summonItem', 'a_olc', 0, 1, 1, 0, 0, 'summonItem id number', 'Invoque <b>number</b> objets d''id <b>id</b> dans votre inventaire'),
...
('38', 'redit', 'a_olc', 0, 1, 1, 0, 0, 'redit', 'Affiche l''éditeur des salles'),
('39', 'rcreate', 'a_olc', 0, 1, 1, 0, 0, 'rcreate [nseobh]', 'Exemple : rcreate n pour créer une nouvelle salle au nord.\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nLes sorties sont reconfigurées par la même occasion entre la salle actuelle et la nouvelle salle.\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nCeci vous déplacera dans la salle créée.'),
('40', 'eat', 'gestion', 1, 0, 0, 1, 0, 'eat nourriture', 'exemple : eat cèpe pour manger un cèpe'),
('41', 'include', 'a_divers', 0, 1, 1, 0, 0, 'include path', 'Tente de charger le fichier indiqué par <b>path</b>. Utiliser avec précaution...'),
...
CREATE TABLE IF NOT EXISTS `heroe` (
  ...
  `spell` text collate latin1_general_ci NOT NULL,
  `inv` text collate latin1_general_ci NOT NULL,
  `equip` text collate latin1_general_ci NOT NULL,
  `shortcut` text collate latin1_general_ci NOT NULL,
...
INSERT INTO `heroe` (`id`, `name`, `password`, `authlevel`, `room`, `xp`, `level`, `hp`, `maxhp`, `mp`, `maxmp`, `str`, `con`, `wis`, `dex`, `skin`, `avatar`, `target`, `spell`, `inv`, `equip`, `shortcut`, `hunger`) VALUES
(1, 'Arsenic', '37eff4bfa7d88a6e75c8804ecff8659b', 1, 1, 30, 1, 120, 120, 10, 10, 5, 5, 5, 5, 'Queen01', 'epeiste2', 0, '{}', '{1=>7, 2=>1}', '{}', '[["Lettre 1", "Skill 5", "Sac 1", "Masque 1", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "get *", "inventory", "who", "option", "o", "n", "s", "e", "aide"]]', -2040),
(6, 'Conap', 'b7a616d4e7c1c12289c6bf3885f62f1a', 1, 1, 1514, 1, 46, 70, 10, 10, 8, 5, 5, 5, 'default', 'default', 0, '{}', '{3=>1000}', '{}', '[["Lettre 2", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]', 0),
(8, 'Maxime', 'b238c13e822536cad3ac57a2280fbf45', 0, 1, 0, 1, 60, 60, 10, 10, 5, 5, 5, 5, 'default', 'default', 0, '{}', '{}', '{}', '[["Lettre 2", "Sac 1", "Masque 1", "Skill 5", "Parchemin 1", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Joyaux 6", "Skill 6"], ["option shortcut", "inventory", "who", "get *", "option", "o", "n", "s", "e", "aide"]]', 0);
...
CREATE TABLE IF NOT EXISTS `room` (
  ...
  `exits` text collate latin1_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE IF NOT EXISTS `world` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(50) collate latin1_general_ci NOT NULL,
  `zones` text collate latin1_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
...
INSERT INTO `zone` (`id`, `name`, `x1`, `y1`, `z1`, `x2`, `y2`, `z2`) VALUES
