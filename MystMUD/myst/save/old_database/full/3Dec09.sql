...
--
-- Serveur: localhost
-- Généré le : Jeu 03 Décembre 2009 à 22:30
...
DROP TABLE `avatar`, `body`, `command`, `commentaires`, `god`, `heroe`, `item`, `mob`, `shop`, `signal`, `skin`, `spell`, `system`, `zone`;
...
('dump', 'a_divers', 0, 1, 1, 0, 'dump variable', 'Affiche la structure d''une <b>variable</b>.<br><u>Exemple :</u> dump commands'),
...
('optionSkin', 'divers', 0, 0, 0, 0, 'optionSkin', 'Il n''y a pas d''aide là-dessus.'),
...
INSERT INTO `heroe` (`id`, `name`, `password`, `god`, `zone`, `x`, `y`, `xp`, `lv`, `hp`, `maxhp`, `mp`, `maxmp`, `str`, `con`, `wis`, `dex`, `skin`, `avatar`, `status`, `target`, `spells`, `inv`, `equip`) VALUES
(1, 'Arsenic', '37eff4bfa7d88a6e75c8804ecff8659b', 1, 1, 0, 0, 0, 1, 42, 120, 10, 10, 5, 5, 5, 5, 'Queen01', 'epeiste2', '', 0, 0x04087b00, 0x04087b00, 0x04087b00),
(6, 'Conap', 'b7a616d4e7c1c12289c6bf3885f62f1a', 1, 1, 5, 5, 1514, 1, 46, 70, 10, 10, 8, 5, 5, 5, 'default', 'default', '', 0, 0x04087b00, 0x04087b00, 0x04087b00),
(8, 'Maxime', 'b238c13e822536cad3ac57a2280fbf45', 0, 1, 0, 0, 0, 1, 60, 60, 10, 10, 5, 5, 5, 5, 'default', 'default', '', 0, 0x04087b00, 0x04087b00, 0x04087b00);
...
(1, 'une épée en bois de cerisier', 'weapon', 1, 0x04087b00, 'Cette épée d''entraînement ne permet de tuer que des rats (et encore)...', 0x04087b00, 0x04087b00, 0x04087b00, 0),
(2, 'un bâton de shaman', 'weapon', 10, 0x04087b00, 'C''est un bâton robuste orné d''une mâchoire de gobelin.', 0x04087b00, 0x04087b00, 0x04087b00, 0),
(3, 'une pièce d''or', 'money', 0, 0x04087b00, 'Ces pièces sont très utilisées dans le commerce.', 0x04087b00, 0x04087b00, 0x04087b00, 1);
...
CREATE TABLE IF NOT EXISTS `mob` (
  ...
  `spells` longblob NOT NULL,
  `inv` longblob NOT NULL,
  `equip` longblob NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `mob` (`id`, `name`, `zone`, `x`, `y`, `xp`, `lv`, `hp`, `maxhp`, `mp`, `maxmp`, `str`, `con`, `wis`, `dex`, `skin`, `avatar`, `status`, `target`, `spells`, `inv`, `equip`) VALUES
(1000000, 'une souris', 1, 0, 0, 0, 1, 50, 50, 100, 100, 5, 5, 5, 5, 'mob/souris', 'mob/souris', '', 0, 0x04087b00, 0x04087b00, 0x04087b00);
