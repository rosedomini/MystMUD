...
--
-- Serveur: localhost
-- Généré le : Sam 08 Mai 2010 à 01:48
...
CREATE TABLE IF NOT EXISTS `avatar` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=40 ;
...
CREATE TABLE IF NOT EXISTS `body` (
  ...
  `inv` text collate utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `command` (
  `id` varchar(30) collate utf8_general_ci NOT NULL,
  ...
  `syntax` varchar(200) collate utf8_general_ci NOT NULL,
  `help` text collate utf8_general_ci NOT NULL,
  UNIQUE KEY `id` (`id`)
...
CREATE TABLE IF NOT EXISTS `heroe` (
  ...
  `password` varchar(120) collate utf8_general_ci NOT NULL,
  `authlevel` tinyint(4) NOT NULL,
  ...
  `wis` int(11) NOT NULL,
  `dex` int(11) NOT NULL,
  `skin` varchar(20) collate utf8_general_ci NOT NULL default 'default',
  `avatar` varchar(20) collate utf8_general_ci NOT NULL default 'default',
  `target` int(11) NOT NULL,
  `spell` text collate utf8_general_ci NOT NULL,
  `inv` text collate utf8_general_ci NOT NULL,
  `equip` text collate utf8_general_ci NOT NULL,
  `shortcut` text collate utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `icon` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=129 ;
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `wearon` text collate utf8_general_ci NOT NULL,
  `desc` text collate utf8_general_ci NOT NULL,
  `stats` text collate utf8_general_ci NOT NULL,
  `power` text collate utf8_general_ci NOT NULL,
  `required` text collate utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mob` (
  ...
  `equip` text collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1000001 ;
...
CREATE TABLE IF NOT EXISTS `room` (
  ...
  `exits` text collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE IF NOT EXISTS `skin` (
  ...
  `source` varchar(20) collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=204 ;
...
CREATE TABLE IF NOT EXISTS `spell` (
  ...
  `desc` varchar(300) collate utf8_general_ci NOT NULL,
  `min_cost` int(11) NOT NULL,
  `max_cost` int(11) NOT NULL,
  `school` varchar(20) collate utf8_general_ci NOT NULL,
  `func` varchar(40) collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `world` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(50) collate utf8_general_ci NOT NULL,
  `areas` text collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`)
