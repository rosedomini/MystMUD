...
--
-- Serveur: localhost
-- Généré le : Sam 03 Juillet 2010 à 16:26
...
(15, 'give', 'donner', 'action', 1, 0, 0, 1, 0, 'give <nom> (<nombre>) <objet>', 'Donne un objet à quelqu''un près de vous (joueur ou créature).'),
...
(2, 1, 'Jardins de l''académie', 'Cet endroit est calme et reposant de part la grandeur des arbres. Les nombreuses odeurs des plantes viennent vous piquer les narines. C''est l''endroit favori du maître d''armes, et il y passe la plupart de son temps.', -1, 0, 0, '{1=>4, 5=>9}', '{}', '{:est=>1, :chemin=>3}'),
...
(4, 1, 'La forge de Sifnos', 'Un bâtiment imposant et bruyant se trouve ici. De la fumée à noirceur variable s''échappe de la cheminée. La porte est grande ouverte.', -3, 0, 0, '{1=>1}', '{}', '{:est=>3, :sud=>5, :porte=>6}'),
